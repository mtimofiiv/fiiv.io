...
var scrollTo = function scrollTo(event) {
  var _event$target$href$sp = event.target.href.split('#'),
      _event$target$href$sp2 = _slicedToArray(_event$target$href$sp, 2),
      selector = _event$target$href$sp2[1];
...
var setSmoothScrolls = function setSmoothScrolls() {
  var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.smooth-scroll';
...
init();
},{"smoothscroll-polyfill":"../node_modules/smoothscroll-polyfill/dist/smoothscroll.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
